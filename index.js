//MODULO PRINCIPAL DE LA PRACTICA

import {presentationGroups, titlesGroups} from "./docs/presentationTournament.js";
...
//Segundo: Desarrollo de la fase de grupos
for ( let i = 0; i < groupLeagues.length -1 ; i++) {
    ...
    groupLeagues.forEach(group => {
        ...
        console.log('')
        console.log(`******* ROUND ${ i + 1} ${titlesGroups[j]} ******`)
        j++
        console.log('')
        ...
        if( i === 2) {
            console.log('')
            console.log(`**WINNER OF THE GROUP : ${group[2].stadisticsDay[0].teamName.toUpperCase()}`)
            console.log(`**SECOND OF THE GROUP : ${group[2].stadisticsDay[1].teamName.toUpperCase()}`)
            console.log('')
            teamsPO.push(group[2].stadisticsDay[0].teamName)
            teamsPO.push(group[2].stadisticsDay[1].teamName)
        }
    })
}
//Desarrollo del PlayOff
console.log('====================================================')
